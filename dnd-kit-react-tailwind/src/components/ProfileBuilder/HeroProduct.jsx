    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow">
      <div className="flex flex-col md:flex-row h-auto md:h-96">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center">
            <div className="uppercase tracking-wide text-xs md:text-sm text-indigo-500 font-bold mb-2">{data.subtitle}</div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4 leading-tight">{data.title}</h2>
