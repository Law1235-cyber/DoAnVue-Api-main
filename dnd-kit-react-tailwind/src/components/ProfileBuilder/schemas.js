...
export const COMPONENT_SCHEMAS = {
  ...
  userName: {
    label: 'User Name',
    fields: [
      { name: 'name', label: 'Name', type: 'text', default: 'John Doe' },
    ],
    styles: [...COMMON_STYLES]
  },
  userInfo: {
    label: 'User Info',
    fields: [
      { name: 'bio', label: 'Bio', type: 'textarea', default: 'This is a short bio about the user.' },
      { name: 'location', label: 'Location', type: 'text', default: 'City, Country' },
    ],
    styles: [...COMMON_STYLES]
  },
  socialLinks: {
    label: 'Social Links',
    fields: [
      { name: 'facebookUrl', label: 'Facebook URL', type: 'text', default: '#' },
  ...
  contactButton: {
    ...
    fields: [
      { name: 'buttonText', label: 'Button Text', type: 'text', default: 'Contact Me' },
      { name: 'buttonColor', label: 'Button Color', type: 'color', default: '#007bff' },
