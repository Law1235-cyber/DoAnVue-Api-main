    ...
    <div className="h-full flex flex-col font-sans bg-white relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-4 bg-red-600 text-white hover:bg-red-700 transition-colors font-bold text-xs tracking-wider uppercase"
        >
          <Trash2 size={15} />
          DELETE BLOCK
        </button>
